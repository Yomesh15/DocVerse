...
const Appointments = () => {
  ...
  const fetchNotifications = async () => {
    try {
      ...
      const res = await axios.get(
        "https://docverse-2.onrender.com/api/notification",
        {
          headers: {
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950 text-white pt-4 pb-26 px-4 md:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-20" data-aos="fade-up">
              <h3 className="text-2xl font-semibold text-white">
                No Appointments, until Doctor Accept or Reject it!
              </h3>
